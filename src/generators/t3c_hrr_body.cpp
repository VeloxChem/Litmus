...
void
T3CHrrFuncBodyDriver::write_func_body(      std::ofstream& fstream,
                                      const I3CIntegral&   integral) const
{
    ...
    lines.push_back({2, 0, 2, "/// set up bra offset for " + t3c::get_hrr_buffer_label(integral)});
...
T3CHrrFuncBodyDriver::_get_ket_buffers_str(const std::vector<R3CDist>& rec_dists,
                                           const I3CIntegral&          integral) const
{
...
std::vector<std::string>
T3CHrrFuncBodyDriver::_get_ket_buffers_str(const I3CIntegral&        integral,
...
bool
T3CHrrFuncBodyDriver::_find_integral(const std::vector<R3CDist>& rec_dists,
...
std::string
T3CHrrFuncBodyDriver::_get_tensor_label(const I3CIntegral& integral) const
{
    std::string label;
...
std::string
T3CHrrFuncBodyDriver::_get_tensor_label(const T3CIntegral& integral) const
{
    std::string label;
...
void
T3CHrrFuncBodyDriver::_add_ket_recursion_loop(      VCodeLines&         lines,
...
std::string
T3CHrrFuncBodyDriver::_get_ket_pragma_str(const I3CIntegral&          integral,
...
R3CDist
T3CHrrFuncBodyDriver::_get_ket_hrr_recursion(const T3CIntegral& integral) const
{
    R3CDist rdist;
    
    if (integral.integrand().name() == "1/|r-r'|")
    {
        T3CHrrElectronRepulsionDriver eri_drv;
...
std::string
T3CHrrFuncBodyDriver::_get_ket_code_line(const R3CDist& rec_distribution) const
{
...
std::string
T3CHrrFuncBodyDriver::_get_ket_rterm_code(const R3CTerm& rec_term,
...
std::string
T3CHrrFuncBodyDriver::_get_component_label(const T3CIntegral& integral) const
{
...
std::string
T3CHrrFuncBodyDriver::_get_ket_component_label(const T3CIntegral& integral) const
{
    std::string label = _get_tensor_label(integral) + "_" + integral[1].label() + "_" +  integral[2].label();
    
    return label;
}

std::string
T3CHrrFuncBodyDriver::_get_ket_offset_def(const I3CIntegral& integral) const
{
...
std::string
T3CHrrFuncBodyDriver::_get_ket_offset_label(const I3CIntegral& integral) const
{
