...
#ifndef t3c_prim_decl_hpp
#define t3c_prim_decl_hpp
...
// Three-center primitive functions declaration generator for CPU.
class T3CPrimDeclDriver
{
    ...
    std::vector<std::string> _get_coordinates_str(const I3CIntegral& integral,
