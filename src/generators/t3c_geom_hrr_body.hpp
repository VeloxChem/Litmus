...
#ifndef t3c_geom_hrr_body_hpp
#define t3c_geom_hrr_body_hpp
...
class T3CGeomHrrFuncBodyDriver
{
    ...
    R3CDist _get_bra_hrr_recursion(const T3CIntegral& integral) const;
    
    /// Generates vector of buffer strings.
    /// @param integral The base four center integral.
    /// @return The vector of buffer strings.
    std::vector<std::string> _get_bra_buffers_str(const std::vector<R3CDist>& rec_dists,
    ...
    /// @return The vector of buffer strings.
    std::vector<std::string> _get_bra_buffers_str(const I3CIntegral&        integral,
    ...
    std::string _get_bra_component_label(const T3CIntegral& integral) const;
    
    /// Gets integral component label.
    /// @param integral The base four center integral component.
    /// @return The string with integral component label.
    std::string _get_full_bra_component_label(const T3CIntegral& integral) const;
    
    /// Gets integral offset definition.
    /// @param integral The base four center integral component.
    /// @return The string with integral offset definition.
    std::string _get_bra_offset_def(const I3CIntegral& integral) const;
    
    /// Gets integral offset definition.
    /// @param integral The base four center integral component.
    /// @return The string with integral offset definition.
    std::string _get_full_bra_offset_def(const I3CIntegral& integral) const;
    
    /// Gets integral offset label.
    /// @param integral The base four center integral component.
    /// @return The string with integral offset label.
    std::string _get_bra_offset_label(const I3CIntegral& integral) const;
    
    /// Gets integral offset label.
    /// @param integral The base four center integral component.
    /// @return The string with integral offset label.
    std::string _get_full_bra_offset_label(const I3CIntegral& integral) const;
    ...
    /// @param integral The base four center integral.
    std::string _get_bra_pragma_str(const I3CIntegral& integral,
    ...
    std::string _get_bra_code_line(const R3CDist& rec_distribution) const;
...
public:
    ...
    T3CGeomHrrFuncBodyDriver() = default;
