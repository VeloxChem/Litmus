...
class T4CFullFuncBodyDriver
{
    ...
    /// @param integral The base four center integral.
    /// @return The vector of strings with GTOS definitions in compute function.
    std::vector<std::string> _get_comp_gtos_def(const I4CIntegral& integral) const;
    ...
    /// Adds loop start definitions to code lines container.
    /// @param lines The code lines container to which loop start definition are added.
    void _add_comp_batches_loop_start(VCodeLines& lines) const;
    ...
    /// @param lines The code lines container to which loop body definition are added.
    /// @param integral The base four center integral.
    void _add_comp_batches_loop_body(      VCodeLines&  lines,
                                     const I4CIntegral& integral) const;
    ...
    /// @param component The base four center integral component.
    /// @param index The index of integral component.
    void _add_comp_component_body(      VCodeLines&  lines,
                                  const I4CIntegral& integral,
                                  const T4CIntegral& component,
                                  const size_t       index) const;
    ...
    /// @param component The base four center integral component.
    /// @param index The index of integral component.
    void _write_comp_block_distributor(      VCodeLines&  lines,
                                       const I4CIntegral& integral,
                                       const T4CIntegral& component,
                                       const size_t       index) const;
...
public:
    ...
    /// @param fstream the file stream.
    /// @param integral The base four center integral.
    void write_comp_func_body(      std::ofstream& fstream,
                              const I4CIntegral&   integral) const;
};
