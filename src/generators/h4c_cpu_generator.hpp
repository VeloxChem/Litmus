...
#ifndef h4c_cpu_generator_hpp
#define h4c_cpu_generator_hpp
...
// Four-center integrals horizontal recursion code generator for CPU.
class H4CCPUGenerator
{
