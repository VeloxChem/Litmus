...
void
T4CHrrFuncBodyDriver::_get_factor_lines(                VCodeLines& lines,
                                         const std::vector<R4CDist>& rec_distributions) const
{
    std::set<std::string> tlabels;
...
std::string
T4CHrrFuncBodyDriver::_get_code_line(const R4CDist& rec_distribution) const
{
...
std::string
T4CHrrFuncBodyDriver::_get_rterm_code(const R4CTerm& rec_term,
