...
void
T3CDeclDriver::write_func_decl(      std::ofstream& fstream,
...
T3CDeclDriver::_get_matrices_str(const I3CIntegral& integral) const
{
...
std::vector<std::string>
T3CDeclDriver::_get_gto_pair_blocks_str(const I3CIntegral& integral) const
{
    std::vector<std::string> vstr;
...
std::vector<std::string>
T3CDeclDriver::_get_indices_str(const I3CIntegral& integral,
                                const bool         terminus) const
{
    std::vector<std::string> vstr;
