...
void
T3CPrimDocuDriver::write_doc_str(      std::ofstream& fstream,
...
std::string
T3CPrimDocuDriver::_get_compute_str(const I3CIntegral& integral) const
{
...
T3CPrimDocuDriver::_get_buffers_str(const I3CIntegral& integral) const
{
...
std::vector<std::string>
T3CPrimDocuDriver::_get_coordinates_str(const I3CIntegral& integral) const
{
    std::vector<std::string> vstr;
    ...
    if (integral[0] > 0)
    {
        vstr.push_back("/// @param idx_wa The vector of distances R(WA) = W - A.");
    }
...
std::vector<std::string>
T3CPrimDocuDriver::_get_recursion_variables_str(const I3CIntegral& integral) const
{
    std::vector<std::string> vstr;
