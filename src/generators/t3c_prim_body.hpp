...
#ifndef t3c_prim_body_hpp
#define t3c_prim_body_hpp
...
class T3CPrimFuncBodyDriver
{
    ...
    std::vector<std::string> _get_buffers_str(const std::vector<R3CDist>& rec_dists,
    ...
    /// @return The vector of buffer strings.
    std::vector<std::string> _get_buffers_str(const I3CIntegral&        integral,
    ...
    /// @param integral The base four center integral.
    std::string _get_pragma_str(const I3CIntegral& integral,
                                const std::vector<R3CDist>& rec_distributions) const;
    ...
    R3CDist _get_vrr_recursion(const T3CIntegral& integral) const;
    ...
    std::string _get_code_line(const R3CDist& rec_distribution) const;
    ...
    std::string _get_rterm_code(const R3CTerm& rec_term,
