...
#ifndef t4c_geom_hrr_cpu_generators_hpp
#define t4c_geom_hrr_cpu_generators_hpp
...
public:
    ...
    T4CGeomHrrCPUGenerator() = default;
...
#endif /* t4c_geom_hrr_cpu_generators_hpp */
