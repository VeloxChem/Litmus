...
#ifndef t3c_hrr_decl_hpp
#define t3c_hrr_decl_hpp
...
// Three-center horizontal recursion functions declaration generator for CPU.
class T3CHrrDeclDriver
{
...
public:
    /// Creates a three-center horizontal recursion functions declaration generator.
    T3CHrrDeclDriver() = default;
