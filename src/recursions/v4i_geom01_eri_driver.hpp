...
#ifndef v4i_geom01_eri_driver_hpp
#define v4i_geom01_eri_driver_hpp
...
class V4IGeom01ElectronRepulsionDriver
{
   
public:
    /// Creates a four center electron repulsion integrals driver.
    V4IGeom01ElectronRepulsionDriver() = default;
...
#endif /* v4i_geom01_eri_driver_hpp */
