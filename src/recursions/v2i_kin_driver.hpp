...
#ifndef v2i_kin_driver_hpp
#define v2i_kin_driver_hpp
...
class V2IKineticEnergyDriver
{
   
public:
    /// Creates a two center kinetic energy integrals driver.
    V2IKineticEnergyDriver() = default;
    ...
    bool is_kinetic_energy(const I2CIntegral& integral) const;
