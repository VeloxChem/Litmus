...
T4CFullElectronRepulsionDriver::T4CFullElectronRepulsionDriver()
{
...
bool
T4CFullElectronRepulsionDriver::is_electron_repulsion(const R4CTerm& rterm) const
{
...
T4CFullElectronRepulsionDriver::bra_vrr_a(const R4CTerm& rterm,
...
std::optional<R4CDist>
T4CFullElectronRepulsionDriver::bra_vrr_b(const R4CTerm& rterm,
                                          const char     axis) const
{
    if (!is_electron_repulsion(rterm)) return std::nullopt;
...
std::optional<R4CDist>
T4CFullElectronRepulsionDriver::ket_vrr_c(const R4CTerm& rterm,
                                          const char     axis) const
{
    if (!is_electron_repulsion(rterm)) return std::nullopt;
...
std::optional<R4CDist>
T4CFullElectronRepulsionDriver::ket_vrr_d(const R4CTerm& rterm,
                                          const char     axis) const
{
    if (!is_electron_repulsion(rterm)) return std::nullopt;
...
R4CDist
T4CFullElectronRepulsionDriver::apply_bra_vrr_a(const R4CTerm& rterm) const
{
    R4CDist t4crt;
...
R4CDist
T4CFullElectronRepulsionDriver::apply_bra_vrr_b(const R4CTerm& rterm) const
{
    R4CDist t4crt;
...
R4CDist
T4CFullElectronRepulsionDriver::apply_ket_vrr_c(const R4CTerm& rterm) const
{
    R4CDist t4crt;
...
R4CDist
T4CFullElectronRepulsionDriver::apply_ket_vrr_d(const R4CTerm& rterm) const
{
    R4CDist t4crt;
...
void
T4CFullElectronRepulsionDriver::apply_recursion(R4CDist& rdist) const
{
...
void
T4CFullElectronRepulsionDriver::apply_bra_vrr_a(R4CDist& rdist) const
{
    if (!rdist.auxilary(0))
    {
...
void
T4CFullElectronRepulsionDriver::apply_bra_vrr_b(R4CDist& rdist) const
{
    if (!rdist.auxilary(1))
    {
        R4CDist new_dist(rdist.root());
...
void
T4CFullElectronRepulsionDriver::apply_ket_vrr_c(R4CDist& rdist) const
{
    if (!rdist.auxilary(2))
    {
        R4CDist new_dist(rdist.root());
...
void
T4CFullElectronRepulsionDriver::apply_ket_vrr_d(R4CDist& rdist) const
{
    if (!rdist.auxilary(3))
    {
        R4CDist new_dist(rdist.root());
...
R4Group
T4CFullElectronRepulsionDriver::create_recursion(const VT4CIntegrals& vints) const
{
...
void
T4CFullElectronRepulsionDriver::apply_recursion(R4Group& rgroup) const
{
