...
bool
V4IGeom1010ElectronRepulsionDriver::is_electron_repulsion(const I4CIntegral& integral) const
{
    if (integral.prefixes_order() != std::vector<int>({1, 0, 1, 0}))
    {
        return false;
    }
...
SI4CIntegrals
V4IGeom1010ElectronRepulsionDriver::bra_hrr(const I4CIntegral& integral) const
{
    SI4CIntegrals tints;
...
SI4CIntegrals
V4IGeom1010ElectronRepulsionDriver::apply_bra_hrr_recursion(const I4CIntegral& integral) const
{
    SI4CIntegrals tints;
