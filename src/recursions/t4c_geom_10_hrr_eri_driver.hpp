...
#ifndef t4c_geom_10_hrr_eri_driver_hpp
#define t4c_geom_10_hrr_eri_driver_hpp
...
class T4CGeom10HrrElectronRepulsionDriver
{
...
public:
    ...
    T4CGeom10HrrElectronRepulsionDriver();
