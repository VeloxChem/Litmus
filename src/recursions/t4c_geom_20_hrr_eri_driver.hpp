...
#ifndef t4c_geom_20_hrr_eri_driver_hpp
#define t4c_geom_20_hrr_eri_driver_hpp
...
class T4CGeom20HrrElectronRepulsionDriver
{
...
public:
    ...
    T4CGeom20HrrElectronRepulsionDriver();
...
#endif /* t4c_geom_20_hrr_eri_driver_hpp */
