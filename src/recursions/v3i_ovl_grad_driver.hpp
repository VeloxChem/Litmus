...
#ifndef v3i_ovl_grad_driver_hpp
#define v3i_ovl_grad_driver_hpp
...
class V3IOverlapGradientDriver
{
   
public:
    /// Creates a three center overlap integrals driver.
    V3IOverlapGradientDriver() = default;
    ...
    bool is_overlap_gradient(const I2CIntegral& integral) const;
