...
#ifndef t3c_ovl_grad_driver_hpp
#define t3c_ovl_grad_driver_hpp
...
class T3COverlapGradientDriver
{
...
public:
    ...
    bool is_overlap_gradient(const R2CTerm& rterm) const;
