...
bool
V2ILocalECPDriver::is_local_ecp(const I2CIntegral& integral) const
{
...
SI2CIntegrals
V2ILocalECPDriver::ket_vrr(const I2CIntegral& integral) const
{
    SI2CIntegrals tints;
...
SI2CIntegrals
V2ILocalECPDriver::apply_ket_vrr(const I2CIntegral& integral) const
{
    SI2CIntegrals tints;
...
SI2CIntegrals
V2ILocalECPDriver::create_recursion(const SI2CIntegrals& integrals) const
{
    SI2CIntegrals tints;
