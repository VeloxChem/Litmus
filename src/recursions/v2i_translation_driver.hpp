...
#ifndef v2i_translation_driver_hpp
#define v2i_translation_driver_hpp
...
class V2ITranslationDriver
{

public:
    /// Creates a two center kinetic energy integrals driver.
    V2ITranslationDriver() = default;
    ...
    bool is_auxiliary(const I2CIntegral& integral) const;
    ...
    SI2CIntegrals operator_vrr(const I2CIntegral& integral) const;
};

#endif /* v2i_translation_driver_hpp */
