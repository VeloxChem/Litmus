...
#ifndef t3c_geom_100_eri_driver_hpp
#define t3c_geom_100_eri_driver_hpp
...
class T3CGeom100ElectronRepulsionDriver
{
...
public:
    ...
    T3CGeom100ElectronRepulsionDriver();
    ...
    std::optional<R3CDist> bra_aux_hrr(const R3CTerm& rterm,
    ...
    /// @return The recursion expansion of given recursion term.
    R3CDist apply_bra_aux_hrr(const R3CTerm& rterm) const;
    
    /// Applies horizontal recursion to bra side  of given recursion term.
    /// @param rterm The recursion term.
    /// @param axis The axis of vertical recursion.
    /// @return The recursion expansion of given recursion term.
    std::optional<R3CDist> bra_hrr(const R3CTerm& rterm,
                                   const char     axis) const;
    ...
    /// @param rterm The recursion term with electron repulsion integral.
    /// @return The recursion expansion of given recursion term.
    R3CDist apply_bra_hrr(const R3CTerm& rterm) const;
};

#endif /* t3c_geom_100_eri_driver_hpp */
