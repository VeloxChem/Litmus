...
#ifndef t3c_geom_010_eri_driver_hpp
#define t3c_geom_010_eri_driver_hpp
...
/// Three center horizontal recursion electron repulsion integrals driver class.
class T3CGeom010ElectronRepulsionDriver
{
...
public:
    ...
    T3CGeom010ElectronRepulsionDriver();
    ...
    std::optional<R3CDist> ket_aux_hrr(const R3CTerm& rterm,
    ...
    /// @return The recursion expansion of given recursion term.
    R3CDist apply_ket_aux_hrr(const R3CTerm& rterm) const;
    
    /// Applies horizontal recursion to bra side  of given recursion term.
    /// @param rterm The recursion term.
    /// @param axis The axis of vertical recursion.
    /// @return The recursion expansion of given recursion term.
    std::optional<R3CDist> ket_hrr(const R3CTerm& rterm,
                                   const char     axis) const;
    ...
    /// @param rterm The recursion term with electron repulsion integral.
    /// @return The recursion expansion of given recursion term.
    R3CDist apply_ket_hrr(const R3CTerm& rterm) const;
};

#endif /* t3c_geom_010_eri_driver_hpp */
