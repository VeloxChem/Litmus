...
#ifndef t2c_hrr_driver_hpp
#define t2c_hrr_driver_hpp
...
/// Two center horizontal  integrals driver class.
class T2CHRRDriver
{
...
public:
    /// Creates a two center horizontal integrals driver.
    T2CHRRDriver();
