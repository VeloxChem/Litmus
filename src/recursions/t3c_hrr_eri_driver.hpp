...
#ifndef t3c_hrr_eri_driver_hpp
#define t3c_hrr_eri_driver_hpp
...
class T3CHrrElectronRepulsionDriver
{
...
public:
    ...
    /// @param rdist The recursion expansion.
    void apply_ket_hrr(R3CDist& rdist) const;
