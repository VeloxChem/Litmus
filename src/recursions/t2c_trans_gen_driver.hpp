...
#ifndef t2c_trans_gen_driver_hpp
#define t2c_trans_gen_driver_hpp
...
public:
    ...
    std::optional<R2CDist> operator_vrr(const R2CTerm& rterm) const;
    
    
};

#endif /* t2c_trans_gen_driver_hpp */
