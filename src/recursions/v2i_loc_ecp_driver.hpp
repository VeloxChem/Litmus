...
#ifndef v2i_loc_ecp_driver_hpp
#define v2i_loc_ecp_driver_hpp

#include <array>

#include "t2c_defs.hpp"

/// Two center local ECP integrals driver class.
class V2ILocalECPDriver
{
   
public:
    /// Creates a two center overlap integrals driver.
    V2ILocalECPDriver() = default;
    ...
    bool is_local_ecp(const I2CIntegral& integral) const;
