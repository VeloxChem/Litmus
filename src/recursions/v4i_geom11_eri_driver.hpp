...
#ifndef v4i_geom11_eri_driver_hpp
#define v4i_geom11_eri_driver_hpp
...
class V4IGeom11ElectronRepulsionDriver
{
   
public:
    /// Creates a four center electron repulsion integrals driver.
    V4IGeom11ElectronRepulsionDriver() = default;
...
#endif /* v4i_geom11_eri_driver_hpp */
