...
#ifndef t4c_geom_11_hrr_eri_driver_hpp
#define t4c_geom_11_hrr_eri_driver_hpp
...
class T4CGeom11HrrElectronRepulsionDriver
{
...
public:
    ...
    T4CGeom11HrrElectronRepulsionDriver();
...
#endif /* t4c_geom_11_hrr_eri_driver_hpp */
