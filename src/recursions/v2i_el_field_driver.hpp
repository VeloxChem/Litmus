...
#ifndef v2i_el_field_driver_hpp
#define v2i_el_field_driver_hpp
...
class V2IElectricFieldDriver
{

public:
    /// Creates a two center nuclear potential integrals driver.
    V2IElectricFieldDriver() = default;
    ...
    bool is_electric_field(const I2CIntegral& integral) const;
